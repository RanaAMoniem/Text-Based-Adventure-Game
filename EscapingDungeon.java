...
public class EscapingDungeon {
    ...
    public static void main(String[] args){
        ...
        if(item.contains("mask") || item.contains("gas")){
            ...
            System.out.println("You have the Gas Mask.");
        }
        ...
        if(item.contains("bag") || item.contains("all")){
            ...
            System.out.println("You have the bag and everything in it.");
        }
        ...
        if(!item.contains("nothing") && itemsChosenCount==0){
            System.out.println("You did not enter anything useful. The adventurer takes nothing.");
        }
